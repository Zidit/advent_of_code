...
def count_ore_requirment(reactions, required, stock={}):
...
#reactions = parse_reaction_list(test_reactions3.split("\n"))
print(reactions)
...
while ore > 0:
    ...
    ore_needed, stock = count_ore_requirment(reactions, {"FUEL": order}, stock)
    ore -= ore_needed
    i += order
    if i % 1000 == 0:
        print(ore)
